...
def Genetic_determ(Ac_Info,Arr_Pool,Arr_NotReady,Ac_queue,Left_queue,tm,NoA,k,prev_class,GA_PopList,GA_Info,wiener_cdf,wlb,wub,Opt_List, norm_approx_min: float, tau: int, Max_LookAhead: int, Time_Sep: List[List[int]], thres1:int, thres2: int, lam1: float, lam2: float, stepthrough:int, step_summ:int, step_new: int):
